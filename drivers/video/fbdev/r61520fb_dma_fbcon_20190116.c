...
static void sunxi_lcdc_init(struct myfb_par *par)
{
  ...
  suniv_setbits(iomm.ccm + FE_CLK_REG, (1 << 31) | (1 << 0));
  suniv_setbits(iomm.ccm + BE_CLK_REG, (1 << 31) | (1 << 0));
  suniv_setbits(iomm.ccm + DI_CLK_REG, (1 << 31) | (1 << 0));
  suniv_setbits(iomm.ccm + TCON_CLK_REG, (1 << 31));
  suniv_setbits(iomm.ccm + BUS_CLK_GATING_REG1, (1 << 14));
  suniv_setbits(iomm.ccm + BUS_CLK_GATING_REG1, (1 << 12));
  suniv_setbits(iomm.ccm + BUS_CLK_GATING_REG1, (1 << 5));
  suniv_setbits(iomm.ccm + BUS_CLK_GATING_REG1, (1 << 4));
